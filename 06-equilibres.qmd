...
Le profit est maximal quand la dérivée du profit suivant les quantités produites est nulle.
...
En discrimination du 3^e^ degré, le monopole se comporte comme s'il était en monopole sur deux marchés différents.
...
À l'aide de la fonction de réaction du follower, on en déduit la quantité du follower.
Le prix est ensuite obtenu en utilisant la demande inverse de la quantité totale.

### Cartel

Quand deux entreprises sont en cartel, elles maximisent leur profit joint.
On écrit donc le profit du cartel, puis on écrit les conditions du premier ordre suivant chaque quantité.
